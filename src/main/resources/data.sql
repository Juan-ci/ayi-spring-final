...
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '1', 'TV Smart Samsung','750', '1', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 1);
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '2', 'Smartphone Alcatel','1750', '2', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 2);
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '3', 'Notebook Lenovo','21750', '3', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 3);
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '4', 'Microondas BGH','22750', '4', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 4);
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '5', 'Lavarropas Drean','2150', '5', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 5);
INSERT INTO `spring_final_ayidb`.`invoice` (`id_invoice`, `description`,  `total`, `client_id`, `soft_delete`) SELECT '6', 'Licuadora Viviana','990', '6', 0
WHERE NOT EXISTS (SELECT * FROM `invoice` WHERE id_invoice = 6);
...
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '1', '1'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 1);
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '2', '2'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 2);
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '3', '3'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 3);
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '4', '4'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 4);
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '5', '5'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 5);
INSERT INTO `spring_final_ayidb`.`client_invoices` (`client_id_client`, `invoices_id_invoice`) SELECT '6', '6'
WHERE NOT EXISTS (SELECT * FROM `client_invoices` WHERE invoices_id_invoice = 6);